      ...
      <div className="about__container">
        ...
        <div className="about__author--info">
          ...
          <p className="about__author--caption">
            My name is Mouachee Thao, I&apos;m a full-stack software engineer
            with a passion for creating interactive and user-friendly
            applications. I use React, JavaScript, and CSS in frontend, and I am
            also experienced with backend technologies like node.js, express.js
            and MongoDB.
          </p>
          <p className="about__author--caption">
